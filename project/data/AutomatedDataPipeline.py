...
def automatedDataPipline():
    ...
    if(df is not None):
        ...
        df.to_sql('shockData', 'sqlite:///./project/data/shockData.sqlite', if_exists='replace', index=False, dtype=columnTypesShock)
    ...
    if(df is not None):
        ...
        #save table to sqlite file
        df.to_sql('location', 'sqlite:///./project/data/locationData.sqlite', if_exists='replace', index=False, dtype=columnTypesLocation)
