...
def automatedDataPipline():
    ...
    if(df is not None):
        ...
        df.to_sql('shockData', 'sqlite:///./main/data/shockData.sqlite', if_exists='replace', index=False, dtype=columnTypesShock)
    ...
    if(df is not None):
        ...
        #save table to sqlite file
        df.to_sql('location', './main/data/sqlite:///./main/data/locationData.sqlite', if_exists='replace', index=False, dtype=columnTypesLocation)
